...
class HeartRateManager: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    @Published var matchLatitude: Double = 0
    @Published var matchLongitude: Double = 0
    ...
    private func handleLocationUpdate(_ location: CLLocation) {
        ...
        if isMonitoring && matchLocation == nil {
            ...
            matchLatitude = location.coordinate.latitude
            matchLongitude = location.coordinate.longitude
    ...
    private func startWorkoutSession() {
        ...
        do {
            ...
            self.matchLatitude = 0
            self.matchLongitude = 0
