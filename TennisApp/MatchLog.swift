...
struct MatchLog: Codable, Identifiable {
    ...
    let transcripts: [String]            // all deciphered speech texts
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case transcripts, latitude, longitude
    }
    ...
    init(id: UUID = UUID(), date: Date, duration: TimeInterval, locationName: String,
         ...
         transcripts: [String] = [], latitude: Double = 0, longitude: Double = 0) {
        self.id = id
        self.date = date
    ...
    init(from decoder: Decoder) throws {
        ...
        // Backward compatible: fields may not exist in old data
        ...
        transcripts = (try? c.decode([String].self, forKey: .transcripts)) ?? []
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encode(transcripts, forKey: .transcripts)
